-- Hitbox type mapping for KOF XI (Atomiswave version).
-- The box type table is expected to be the same as the PS2 version since
-- both versions share the same game engine and hitbox ID system.
-- This file is a direct copy of the PS2 version's boxtypes.lua.
