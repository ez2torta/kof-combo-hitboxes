...
local MemLogger = require("game.pcsx2.kof_xi.memlogger")
...
function KOF_XI:checkInputs()
	...
	if hk.pressed(hk.VK_F10) then
		self.memlogger:toggle()
	end
end
